...
namespace yourgame
{
    ...
    public:
        ...
        GLSpriteGrid(GLSpriteGrid const &) = delete;
        GLSpriteGrid &operator=(GLSpriteGrid const &) = delete;
         ...
         */
        int make(const yourgame::GLTextureAtlas *atlas,
        ...
        GLGeometry *geo() const { return m_geo; }

    private:
        GLGeometry *m_geo = nullptr;
    };
} // namespace yourgame
