...
// emscripten implements glfw v3.2 API only (2020-12-12)
        ...
        for (const auto &pad : gamepadFirstButtonAxisIdx)
        {
            ...
            if (glfwGetGamepadState(pad.first, &state))
            {
                ...
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_A] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_B] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_X] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_Y] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_LEFT_BUMPER] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_BACK] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_START] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_GUIDE] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_LEFT_THUMB] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_RIGHT_THUMB] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_DPAD_UP] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_DPAD_RIGHT] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_DPAD_DOWN] == GLFW_PRESS ? 1.0f : 0.0f);
                yourgame_internal::setInput(static_cast<yourgame::input::Source>(buttonWriteIdx++), state.buttons[GLFW_GAMEPAD_BUTTON_DPAD_LEFT] == GLFW_PRESS ? 1.0f : 0.0f);
                int axisWriteIdx = static_cast<int>(pad.second.second);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_LEFT_X]);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_LEFT_Y]);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_RIGHT_X]);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_RIGHT_Y]);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_LEFT_TRIGGER]);
                yourgame_internal::setInput2(static_cast<yourgame::input::Source>(axisWriteIdx++), state.axes[GLFW_GAMEPAD_AXIS_RIGHT_TRIGGER]);
            }
        }
#endif
    }
