...
namespace yourgame
{
    GLFramebuffer *GLFramebuffer::make(GLsizei width, GLsizei height, std::vector<TextureAttachDescr> texAttachDescrs)
    {
        GLFramebuffer *newFrameBuf = new GLFramebuffer();
