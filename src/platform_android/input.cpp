            ...
            int32_t handleInputEvent(AInputEvent *inputEvent)
            {
                ...
                case AINPUT_EVENT_TYPE_MOTION:
                {
                    ...
                    case AMOTION_EVENT_ACTION_POINTER_UP:
                    {
                        ...
                        {
                            yourgame_internal::input::setInput(srcsTouchDown[evPointerId], ((evAction == AMOTION_EVENT_ACTION_DOWN ||
                                                                                             evAction == AMOTION_EVENT_ACTION_POINTER_DOWN)
                                                                                                ? 1.0f
                                                                                                : 0.0f));
                            // set initial location
                            yourgame_internal::input::setInput2(srcsTouchX[evPointerId], (float)AMotionEvent_getX(inputEvent, evPointerIndex));
                            yourgame_internal::input::setInput2(srcsTouchY[evPointerId], (float)AMotionEvent_getY(inputEvent, evPointerIndex));
                        }
                    }
                    break;
                    case AMOTION_EVENT_ACTION_MOVE:
                    {
                        ...
                        for (auto i = 0; i < evNumPtr; i++)
                        {
                            ...
                            yourgame_internal::input::setInput2(srcsTouchX[pointerId], (float)AMotionEvent_getX(inputEvent, i));
                            yourgame_internal::input::setInput2(srcsTouchY[pointerId], (float)AMotionEvent_getY(inputEvent, i));
                        }
                    }
                    break;
                    default:
